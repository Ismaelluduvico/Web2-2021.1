        ...
        <form action="{{route('entradas.store')}}" method="post"> 
            @csrf
                ...
                <ul>
                    ...
                    <li><input type="text" class="form-control @error('valor_total_da_nota') is-invalid @enderror" name="valor_total_da_nota" id="valor_total_da_nota">
                        @error('valor_total_da_nota')
